<x-form.modal title="{!! isset($data->id) ? 'Edit Pejabat' : 'Tambah Pejabat' !!}" action="{{ $action ?? null }}">
    @if ($data->id)
        @method('put')
    @endif
    <div class="row">
        ...
        <div class="col-md-5">
            <x-form.input name="nip" value="{{ str_replace(' ', '', $data->nip) }}" label="NIP" placeholder="198012122006011001" />
        </div>
        <div class="col-md-7">
            <div class="mb-3">
