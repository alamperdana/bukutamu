@extends('layouts.app', ['title' => 'Tahun Anggaran'])
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-1">
                    @can('create master-data/tahun')
                        <a class="btn btn-primary action" href="{{ route('master-data.tahun.create') }}">
                            <span class="tf-icons ti-xs ti ti-plus me-2"></span>Tambah Tahun
                        </a>
                        <a class="btn btn-secondary action" href="{{ route('master-data.tahun.archive') }}">
