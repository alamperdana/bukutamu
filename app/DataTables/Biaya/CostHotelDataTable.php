...
class CostHotelDataTable extends DataTable
{
    use DatatableHelper;
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        $columnsToFormat = [
            'walkot', 'sekda', 'eselon_2', 'eselon_3', 'eselon_4', 'gol_4', 'gol_3', 'gol_2', 'gol_1', 'tkk'
        ];
     ...
     */
    public function query(CostHotel $model): QueryBuilder
    {
