...
class CostHotelDDDataTable extends DataTable
{
    use DatatableHelper;
    /**
     ...
     */
    public function query(CostHotelDD $model): QueryBuilder
    {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('lev_4')->title('Eselon 3,<br>Tenaga Ahli & Pakar'),
            Column::make('lev_5')->title('Eselon 4'),
            Column::make('lev_6')->title('Gol 4, 3 &<br>Tokoh Masyarakat'),
            Column::make('lev_7')->title('Gol 2, 1 <br>Honorer & TKK'),
    ...
    {
        return 'CostHotelDD_' . date('YmdHis');
    }
}
