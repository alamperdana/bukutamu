...
class CostRepresentasiDataTable extends DataTable
{
    use DatatableHelper;
    /**
     ...
     */
    public function query(CostRepresentasi $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('costrepresentasi-table')
    ...
    {
        return 'CostRepresentasi_' . date('YmdHis');
    }
}
