...
class LokasiLayananDataTable extends DataTable
{
    use DatatableHelper;
    /**
     ...
     */
    public function query(LokasiLayanan $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('lokasilayanan-table')
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('lokasi_layanan')->title('Lokasi Pelayanan'),
    ...
    {
        return 'LokasiLayanan_' . date('YmdHis');
    }
}
