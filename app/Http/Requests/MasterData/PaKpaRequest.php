...
class PaKpaRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'nip' => [
                ...
                'numeric',
                'digits:18',
                Rule::unique('pakpa')->where(function ($query) use ($kodesatker, $tahun) {
                    return $query->whereJsonContains('session_input', [
                        'tahun' => $tahun,
                        'kode_satker' => $kodesatker,
                        'username' => auth()->user()->username,
                    ]);
                })->ignore($this->route('pakpa'))
            ], 
            'pangkat_id' => [
                'required',
                'exists:pangkat,id'
    ...
    public function messages(): array
    {
        return [
            ...
            'payes.required' => 'PA/KPA wajib dipilih.',
            'payes.boolean' => 'Pilih PA atau KPA.',
        ];
    }
}
