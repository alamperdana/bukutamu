        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-1" style="width: 60%;">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create referensi/lokasi')): ?>
                        <a class="btn btn-primary action" href="<?php echo e(route('referensi.lokasi.create')); ?>">
            ...
            <div class="card-body p-2 d-flex gap-3">
                ...
                <div class="flex-shrink-0 d-flex align-items-center justify-content-center" style="width: 40%;">
                    <img src="<?php echo e(asset('assets/img/cartoon/lokasi.png')); ?>" class="img-fluid" alt="Gambar Pendamping" style="max-height: 300px;" />
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', ['title' => 'Daftar Lokasi Pelayanan'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/perdana/Work/LaravelApp/bukutamu/resources/views/pages/referensi/lokasi.blade.php ENDPATH**/ ?>