    ...
    <script>
        ...
        handleAction(datatable, function() {
            ...
            $('.copy').on('change', function() {
                handleAjax(`<?php echo e(url('konfigurasi/akses-user')); ?>/${this.value}/user`)
...
<?php echo $__env->make('layouts.app', ['title' => 'User'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/perdana/Work/LaravelApp/bukutamu/resources/views/pages/konfigurasi/akses-user.blade.php ENDPATH**/ ?>