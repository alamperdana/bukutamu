            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-1">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create konfigurasi/roles')): ?>
                        <a class="btn btn-primary action" href="<?php echo e(route('konfigurasi.roles.create')); ?>">
...
<?php echo $__env->make('layouts.app', ['title' => 'Role'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/perdana/Work/LaravelApp/bukutamu/resources/views/pages/konfigurasi/role.blade.php ENDPATH**/ ?>